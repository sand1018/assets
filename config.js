...
function main(config) {
  ...
  Object.assign(config, {
    ...
    rules: [
      ...
      "AND,((NETWORK,UDP),(DST-PORT,3478)),WebRTC",
      "AND,((NETWORK,TCP),(DST-PORT,3478)),WebRTC",
      "AND,((NETWORK,UDP),(DST-PORT,19302)),WebRTC",
      "AND,((NETWORK,TCP),(DST-PORT,19302)),WebRTC",
      "AND,((NETWORK,UDP),(DST-PORT,5349)),WebRTC",
      "AND,((NETWORK,TCP),(DST-PORT,5349)),WebRTC",
...
// 构建有节点时的策略组：WebRTC 默认跟随 Proxy，并保留同样的可选项。
...
function buildRejectGroups() {
  return [
    ...
    { name: "WebRTC", type: "select", proxies: ["REJECT"] },
